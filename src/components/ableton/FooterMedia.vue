<template>
  <section class="media">
    <ul class="media-list">
      <li class="media-item"><a href="">Register Live or Push</a></li>
      <li class="media-item"><a href="">About Ableton</a></li>
      <li class="media-item"><a href="">Jobs</a></li>
      <li class="social-media">
        <ul class="social-media-list">
          <li class="social-media-list-item facebook">
            <a href=""
              ><svg
          ...
          <li class="social-media-list-item youtube">
            <a href="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 40 40"
